...
import getStyleValueFromLine from "../../getStyleValueFromLine";
import hasCommonElements from "../../hasCommonElements";
import extractColors from "../extractColors/client";
...
const fillOrReplace = (
    ...
    for (const element of elements) {
        const elemColors = extractColors(element, true) as SvgColors;
